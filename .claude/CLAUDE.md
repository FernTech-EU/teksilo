...
cargo run -p widget-catalog -- --theme fluent-dark   # …in a preset's true chrome (also fluent-light, material3-{light,dark}, intui-{light,dark}); the title-bar ThemeSwitcher re-tints live but keeps the shapes the tree was built with
