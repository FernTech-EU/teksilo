...
teksilo-automation      GUI-free automation toolkit: serde DTOs, `execute(tree, ops, op, settle)`,
                     the 27-tool catalog, and the `wire` framing/token protocol. Core-only peer,
                     like teksilo-data.
