...
bastyde-data            Reactive data models, designed as a *peer* of the GUI, not part of it: depends on
                     ...
                     `&T` directly to delegates, no `QVariant`, no role integers.
                       ...
                       • Divergence side-channel: `TreeSlice` / `SortFilterTreeModel` /
