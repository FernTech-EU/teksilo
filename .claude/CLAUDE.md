...
cargo run -p tree-table                         # TreeTable showcase (mock filesystem, auto-measured variable row heights)
...
cargo run -p docking                             # DockingLayout: VS Code-style dockable IDE shell — centre editor + 4 collapsible/splittable/draggable sides, activity rail, per-corner ownership, drag-to-dock, export/restore. See docs/docking.md
```
