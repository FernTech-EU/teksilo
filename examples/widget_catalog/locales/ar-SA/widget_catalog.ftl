...
tab-layout-refs = المكدِّسات والشبكات وتوزيع المساحة الفائضة. انظر: cargo run -p text_and_layout, cargo run -p splitter.
tab-visuals-refs = أوّليّات العرض والأيقونات والصور وأشرطة التحقق. انظر: cargo run -p simple_button.
tab-containers-refs = الألواح والبطاقات والأكورديون ومناطق التمرير والعروض المنقسمة. انظر: cargo run -p splitter, cargo run -p tool_box.
...
ovr-tooltip-hover = مرِّر أو اضغط مطوّلًا
...
overlays-hover-me = مرِّر أو اضغط مطوّلًا
...
ovr-hover-level-1 = تمرير أو ضغط مطوّل — المستوى 1
ovr-hover-level-2 = تمرير أو ضغط مطوّل — المستوى 2
ovr-hover-level-3 = تمرير أو ضغط مطوّل — المستوى 3
ovr-plain-among-rich = بسيط بين المنسّقة
ovr-plain-among-rich-tip = تلميح بسيط في العمود المنسّق — تشخيصي.
ovr-rich-dwell-tip = تلميح: امكث ~٢ ثانية للتثبيت، ثم انقر الروابط للتسلسل. الإصبع لا يُمرِّر أبدًا — اضغط الزر مطوّلًا.
...
# ── تبويب اللمس ───────────────────────────────────────────────────
tab-touch-title = اللمس
tab-touch-refs = سلم الكثافة، وملفات الإيماءات الثلاثة، وما يحصل عليه الإصبع ولا تحصل عليه الفأرة. انظر: cargo run -p touch-playground.
touch-section-ladder = سلم الكثافة
touch-ladder-note = أعد التشغيل بـ --density comfortable أو --density touch لبناء الكتالوج بأكمله على درجة أخرى. تُقرَّر الكثافة داخل كل build()، ولذلك هي راية لا مفتاح.
touch-section-profiles = ملفات الإيماءات
touch-profiles-note = العتبات هي كل الفرق بين الأجهزة — مسار الشيفرة نفسه. لا تملك الفأرة عتبة تحريك على الإطلاق، ولهذا لا يُمرِّر سحبُها أبدًا.
touch-section-pan = التمرير بالإصبع، وإعادة الترتيب بعد ضغطة مطوّلة
touch-pan-note = اسحب بإصبعك فتُمرَّر القائمة؛ واضغط مطوّلًا على صف أولًا فيُعيد السحب نفسه ترتيبه. أما الفأرة فتُعيد الترتيب فورًا وتُمرِّر بالبكرة.
touch-section-manipulator = المِقبَض ليس تحريكًا أبدًا
touch-manipulator-note = يُعلن المنزلق أنه لا يسمح بأي سلوك لمس افتراضي فوقه، فسحب المقبض يُغيّر القيمة على كل جهاز. اسحب في أي مكان آخر داخل الإطار فيُمرَّر الإطار.
touch-slider-label = القيمة
touch-section-targets = أهداف القبض
touch-targets-note = يُرسم الفاصل بمقاس القبض الخاص بالسمة ثم يُوسَّع للمؤشر الخشن بامتداد منطقة الإصابة الخاصة بالودجة، فما تراه وما يمكنك إصابته مقاسان مختلفان بقصد.
touch-section-text = النص باللمس
touch-text-note = تضع النقرة المؤشر عند رفع الإصبع، وتُحدّد الضغطة المطوّلة الكلمة تحته وتُظهر مقبضين، وسحب المقبض يُحرّك ذلك الطرف من التحديد.
touch-text-placeholder = انقر، اضغط مطوّلًا، اسحب مقبضًا
touch-playground-note = يُبلِّغ cargo run -p touch-playground عن كل مؤشر يستقبله، ويُسمّي المتنافس الذي فاز بكل ضغطة، ويُبدِّل الكثافة والثوابت الحركية أثناء التشغيل. وdocs/touch-verification.md هي قائمة التحقق لجهاز حقيقي.
