...
//! [`teksilo_core::telemetry::UsageReporter`].
...
impl PlausibleAdapterBuilder {
    ...
    /// fed the `teksilo_telemetry::scopes::TELEMETRY_ENDPOINT_OVERRIDE`
    ...
    ///
    /// Typical path:
    /// `paths.data_dir().join("teksilo-telemetry/plausible-queue.redb")`.
