...
calendar-name-with-month = Calendrier, { $month }
calendar-value-with-selection = { $focused } (sélection : { $selection })
calendar-value-on-selection = { $date } (sélectionné)
calendar-date-range = du { $start } au { $end }
calendar-decade = de { $start } à { $end }
