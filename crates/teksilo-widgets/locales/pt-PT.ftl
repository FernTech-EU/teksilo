...
calendar-name-with-month = Calendário, { $month }
calendar-value-with-selection = { $focused } (selecionado: { $selection })
calendar-value-on-selection = { $date } (selecionado)
calendar-date-range = de { $start } a { $end }
