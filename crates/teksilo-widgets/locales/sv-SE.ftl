...
calendar-value-with-selection = { $focused } (valt: { $selection })
calendar-value-on-selection = { $date } (vald)
calendar-date-range = från { $start } till { $end }
calendar-decade = från { $start } till { $end }
