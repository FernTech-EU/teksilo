...
calendar-value-with-selection = { $focused } (selezionato: { $selection })
calendar-value-on-selection = { $date } (selezionato)
calendar-date-range = dal { $start } al { $end }
calendar-decade = dal { $start } al { $end }
