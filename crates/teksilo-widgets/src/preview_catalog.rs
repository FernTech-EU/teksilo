...
//! `WidgetCatalog` impls for `teksilo-widgets`.
//!
...
use teksilo_core::styles::{CheckboxVariant, TextInputVariant};
...
register_widget_catalog_at!("crates/teksilo-widgets/src/button.rs", Button);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/primitives/vstack.rs", VStack);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/primitives/hstack.rs", HStack);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/primitives/zstack.rs", ZStack);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/primitives/grid.rs", Grid);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/primitives/padding.rs", Padding);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/primitives/expand.rs", Expand);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/primitives/center.rs", Center);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/primitives/spacer.rs", Spacer);
...
impl WidgetCatalog for TextWidget {
    ...
    fn display_name() -> &'static str {
        ...
        // names to catalog entries (e.g. teksilo-designer's interpreter) rely
...
register_widget_catalog_at!(
    "crates/teksilo-widgets/src/primitives/text_widget.rs",
    TextWidget
);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/text_input.rs", TextInput);
...
register_widget_catalog_at!(
    "crates/teksilo-widgets/src/text_scale_control.rs",
    TextScaleControl
);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/checkbox.rs", Checkbox);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/radio_button.rs", RadioButton);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/toggle.rs", Toggle);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/slider.rs", Slider);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/progress_bar.rs", ProgressBar);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/badge.rs", Badge);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/avatar.rs", Avatar);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/link.rs", Link);
...
register_widget_catalog_at!(
    "crates/teksilo-widgets/src/segmented_control.rs",
    SegmentedControl
);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/combo_box.rs", ComboBox<String>);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/font_picker.rs", FontPicker);
...
register_widget_catalog_at!(
    "crates/teksilo-widgets/src/language_switcher.rs",
    LanguageSwitcher
);
...
register_widget_catalog_at!(
    "crates/teksilo-widgets/src/theme_switcher.rs",
    ThemeSwitcher
);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/card.rs", Card);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/panel.rs", Panel);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/group_box.rs", GroupBox);
...
impl WidgetCatalog for GroupHeader {
    ...
    fn build(variant: &str, knobs: &KnobValues) -> Box<dyn Widget> {
        ...
        match variant {
            "accent" => Box::new(
                header
                    .style(teksilo_tokens::TextStyleRole::BodyBold)
                    .color(teksilo_tokens::TextRole::Accent),
            ),
            _ => Box::new(header),
        }
    }
}
register_widget_catalog_at!("crates/teksilo-widgets/src/group_header.rs", GroupHeader);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/icon_button.rs", IconButton);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/snackbar.rs", Snackbar);
        ...
        fn build_path() -> Box<dyn Widget> {
            Box::new(
                Breadcrumb::new()
                    ...
                    .item(BreadcrumbItem::new(lit!("Teksilo",)))
...
register_widget_catalog_at!("crates/teksilo-widgets/src/breadcrumb.rs", Breadcrumb);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/toolbar.rs", Toolbar);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/status_bar.rs", StatusBar);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/accordion.rs", Accordion);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/radio_group.rs", RadioGroup);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/radio_tile.rs", RadioTile);
...
register_widget_catalog_at!(
    "crates/teksilo-widgets/src/radio_tile_group.rs",
    RadioTileGroup
);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/split_button.rs", SplitButton);
...
impl WidgetCatalog for ListView<String> {
    ...
    fn variants() -> Vec<PreviewVariant> {
        fn build_short() -> Box<dyn Widget> {
            let model = teksilo_data::ListModel::from_vec(vec![
                "Apple".to_string(),
                "Banana".to_string(),
                "Cherry".to_string(),
                "Date".to_string(),
...
register_widget_catalog_at!("crates/teksilo-widgets/src/list_view.rs", ListView<String>);
...
impl WidgetCatalog for GridView<String> {
    ...
    fn variants() -> Vec<PreviewVariant> {
        fn items(n: usize) -> teksilo_data::ListModel<String> {
            teksilo_data::ListModel::from_vec((0..n).map(|i| format!("Tile {i}")).collect())
        }
...
register_widget_catalog_at!("crates/teksilo-widgets/src/grid_view.rs", GridView<String>);
...
impl WidgetCatalog for TreeView<String> {
    ...
    fn variants() -> Vec<PreviewVariant> {
        fn build_default() -> Box<dyn Widget> {
            let model = teksilo_data::TreeModel::<String>::new();
            let root = model.insert_root(0, "Project".to_string());
            let crates_node = model.insert_child(root, 0, "crates".to_string());
            model.insert_child(crates_node, 0, "teksilo-core".to_string());
            model.insert_child(crates_node, 1, "teksilo-widgets".to_string());
            model.insert_child(crates_node, 2, "teksilo-render".to_string());
...
register_widget_catalog_at!("crates/teksilo-widgets/src/tree_view.rs", TreeView<String>);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/menu_list.rs", MenuList);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/scroll_area.rs", ScrollArea);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/splitter.rs", Splitter);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/tab_widget.rs", TabWidget);
...
register_widget_catalog_at!("crates/teksilo-widgets/src/tool_box.rs", ToolBox);
...
register_widget_catalog_at!(
    "crates/teksilo-widgets/src/repeater.rs",
...
mod color_family {
    ...
    register_widget_catalog_at!(
        "crates/teksilo-widgets/src/hex_color_input.rs",
        HexColorInput
    );
    ...
    register_widget_catalog_at!("crates/teksilo-widgets/src/color_picker.rs", ColorPicker);
    ...
    register_widget_catalog_at!("crates/teksilo-widgets/src/color_edit.rs", ColorEdit);
}
...
mod secure_input_family {
    ...
    register_widget_catalog_at!(
        "crates/teksilo-widgets/src/password_field.rs",
        PasswordField
    );
}
...
mod build_with_children_tests {
    ...
    use teksilo_preview::{CatalogEntry, KnobValues, SlottedChild, WidgetCategory, find_by_id};
