...
//! `teksilo.rich_text.*` intent for applications that want to observe
...
/// [`HandlerSet::context_menu`](teksilo_core::widget_builder::HandlerSet::context_menu);
...
/// [`teksilo_core::widget_builder::ContextMenuFactory`]. Re-declared
...
mod tests {
    ...
    fn intent_names_use_reserved_teksilo_prefix() {
        // The `teksilo.` prefix is the framework's reserved namespace
