...
use teksilo_canvas::{Canvas, EdgeInsets, Point, Rect, Size, SizeProposal, StrokeStyle};
...
impl ColumnFlow {
    ...
    ///
    /// [`Widget::place_children`]: teksilo_core::widget::Widget::place_children
...
mod tests {
    ...
    fn default_container_is_pruned_and_children_promoted_in_source_order() {
        ...
        let root = update
            .nodes
            .iter()
            .find(|(n, _)| *n == teksilo_core::accessibility::root_node_id())
            .map(|(_, node)| node)
