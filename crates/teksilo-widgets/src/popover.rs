...
pub struct Popover {
    ...
    surface_variant: teksilo_core::styles::PopoverVariant,
    ...
    style_override: Option<teksilo_core::styles::SharedPopoverStyle>,
...
impl Popover {
    ...
    pub fn new(label: impl Into<LocalizedString>) -> Self {
        ...
        Self {
            ...
            show_caret: true,
            caret_size: 10.0,
            surface_variant: teksilo_core::styles::PopoverVariant::default(),
            style_override: None,
...
impl Widget for Popover {
    fn build(&mut self, ctx: &mut BuildContext) -> Vec<WidgetId> {
        ...
        let surface_style: teksilo_core::styles::SharedPopoverStyle = self
            .style_override
            .clone()
            .or_else(|| ctx.theme().style_slots.popover.clone())
            .unwrap_or_else(|| Rc::new(crate::styles::RecipePopoverStyle::default()));
        let surface_cfg = teksilo_core::styles::PopoverStyleConfig {
        ...
        let dismiss_callback: teksilo_core::overlay::OverlayDismissCallback = {
...
mod tests {
    ...
    fn caret_increases_popover_height_for_below_placement() {
        let mut plain_tree = WidgetTree::new().with_theme(teksilo_core::presets::intui::light());
        plain_tree.add(
            Popover::new(lit!("Show popover"))
                .content(FixedLeaf(140.0, 60.0))
        ...
        let mut caret_tree = WidgetTree::new().with_theme(teksilo_core::presets::intui::light());
        caret_tree.add(
            Popover::new(lit!("Show popover"))
                .content(FixedLeaf(140.0, 60.0))
                .placement(OverlayPlacement::Below)
