...
type OnValueChanged = Rc<dyn Fn(Option<Color>, &mut teksilo_core::widget::EventContext)>;
type OnInvalid = Rc<dyn Fn(&str, &mut teksilo_core::widget::EventContext)>;
...
impl HexColorInput {
    ...
    pub fn on_value_changed(
        mut self,
        f: impl Fn(Option<Color>, &mut teksilo_core::widget::EventContext) + 'static,
    ) -> Self {
    ...
    pub fn on_invalid(
        mut self,
        f: impl Fn(&str, &mut teksilo_core::widget::EventContext) + 'static,
    ) -> Self {
...
impl Widget for HexColorInput {
    fn build(&mut self, ctx: &mut BuildContext) -> Vec<WidgetId> {
        ...
        let commit: Rc<dyn Fn(&mut teksilo_core::widget::EventContext)> = {
            ...
            let last_raw = last_raw.clone();
            Rc::new(move |ctx_evt: &mut teksilo_core::widget::EventContext| {
