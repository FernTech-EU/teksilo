...
/// [`ShortcutRegistry`](teksilo_core::shortcut::ShortcutRegistry) via
...
// `install_tooltip_registry` from `TeksiloAppBuilder::register_tooltips`
...
// used by `teksilo-i18n`'s thread-local manager slot.
thread_local! {
