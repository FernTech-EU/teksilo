...
//!   [`RichTextEngine::layout_window_from_snapshots`](teksilo_text::RichTextEngine::layout_window_from_snapshots),
...
pub(crate) fn a11y_window(
    ...
    usize,
    usize,
    Vec<teksilo_text::text_document::BlockSnapshot>,
) {
...
fn collect_window(
    ...
    usize,
    teksilo_text::text_document::BlockSnapshot,
    Option<[f32; 4]>,
)> {
...
fn resolve_row_position(
    doc: &teksilo_text::text_document::TextDocument,
    target: usize,
