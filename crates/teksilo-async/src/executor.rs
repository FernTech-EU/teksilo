...
//! event-loop turn by the [`on_loop_tick`](teksilo_app::TeksiloAppBuilder::on_loop_tick)
//! hook in `teksilo-app`.
//!
//! ## Why hand-rolled
//!
...
/// loop when a task becomes runnable from another thread. `teksilo-app` does
...
/// [`install_async`](crate::TeksiloAppBuilderAsyncExt::install_async) and
