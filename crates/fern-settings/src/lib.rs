//! `fern-settings` — persistent, reactive user preferences for FernUI.
//!
...
//!
//! ```
//! use fern_settings::{AppPaths, SettingsStore, SettingsKey};
//!
