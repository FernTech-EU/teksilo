...
use bastyde_canvas::{RenderFrame, SizeProposal};
use bastyde_core::signal::Signal;
use bastyde_core::widget::Widget;
use bastyde_core::widget_tree::WidgetTree;
use bastyde_i18n::lit;
use bastyde_widgets::button::{Button, ButtonVariant};
use bastyde_widgets::checkbox::Checkbox;
use bastyde_widgets::combo_box::ComboBox;
use bastyde_widgets::primitives::VStack;
use bastyde_widgets::slider::Slider;
use bastyde_widgets::spin_box::SpinBox;
use bastyde_widgets::toggle::Toggle;
