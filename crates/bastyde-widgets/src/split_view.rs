...
impl Widget for SplitHandle {
            ...
            .on_access_action({
                ...
                move |action, _ctx| {
                    ...
                    let delta = match action {
                        bastyde_core::accesskit::Action::Increment => Some(step),
                        bastyde_core::accesskit::Action::Decrement => Some(-step),
                        _ => None,
                    };
    ...
    fn accessibility(&self, builder: &mut AccessNodeBuilder) {
        ...
        builder.set_name(bastyde_i18n::tr_widget!(a11y_split_view_divider_name()).resolve_now());
        ...
        let handle_orientation = match self.orientation {
            Orientation::Horizontal => bastyde_core::accesskit::Orientation::Vertical,
            Orientation::Vertical => bastyde_core::accesskit::Orientation::Horizontal,
        };
...
impl SplitView {
    ...
    fn resolved_style(&self, _theme: &bastyde_core::Theme) -> ResolvedStyle {
        ResolvedStyle {
