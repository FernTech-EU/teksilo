...
use bastyde_core::styles::{PanelStyleConfig, PanelVariant, SharedPanelStyle};
...
impl Panel {
    ...
    /// Override the background. Accepts `Color`, a [`SurfaceRole`](bastyde_tokens::SurfaceRole),
    ...
    /// Override the border color. Accepts `Color`, a [`BorderRole`](bastyde_tokens::BorderRole),
