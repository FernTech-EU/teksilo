...
//! [`WindowState::placement`](bastyde_core::window::WindowState::placement) and
...
//!
//! [`PlatformTitleBarHost::has_window_menu`]: bastyde_core::PlatformTitleBarHost::has_window_menu
