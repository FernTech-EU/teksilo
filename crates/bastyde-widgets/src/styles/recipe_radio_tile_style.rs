...
use bastyde_core::styles::{RadioTileStyle, RadioTileStyleConfig, RadioTileVariant};
...
/// Default `RadioTileStyle` shipped with Bastyde.
    ...
    fn place_children(
        ...
        for child in children.iter_mut() {
            if self.is_compact {
                ...
                child.origin = bastyde_canvas::Point::new(bounds.x + pad, y);
