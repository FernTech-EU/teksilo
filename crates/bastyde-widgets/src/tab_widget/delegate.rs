...
/// [`bastyde_core::widget_builder::ContextMenuFactory`] — receives the
...
impl From<TabBarOrientation> for bastyde_core::styles::TabBarOrientation {
    fn from(o: TabBarOrientation) -> Self {
        match o {
            TabBarOrientation::Horizontal => bastyde_core::styles::TabBarOrientation::Horizontal,
            TabBarOrientation::Vertical => bastyde_core::styles::TabBarOrientation::Vertical,
        }
    }
}
