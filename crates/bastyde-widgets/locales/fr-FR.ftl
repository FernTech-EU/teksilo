...
# bastyde-i18n's own fallback, not `fluent-bundle`'s built-in per-key
...
# Widget PrivacySettings. Voir crates/bastyde-widgets/src/privacy_settings.rs.
...
# et les modules communs sous crates/bastyde-widgets/src/common/datetime/.
...
# ThemeSwitcher widget. Voir crates/bastyde-widgets/src/theme_switcher.rs.
