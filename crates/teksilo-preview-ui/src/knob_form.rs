...
use teksilo_preview::{KnobDecl, KnobKind, KnobSpec, KnobValues};
...
fn build_text_role(ctx: &mut BuildContext, decl: &KnobDecl, values: &KnobValues) -> WidgetId {
    ...
    build_enum_combo(
        ...
        vec![
            ...
            (TextRole::OnError, "OnError"),
            (TextRole::OnErrorContainer, "OnErrorContainer"),
...
fn build_surface_role(ctx: &mut BuildContext, decl: &KnobDecl, values: &KnobValues) -> WidgetId {
    ...
    build_enum_combo(
        ...
        vec![
            ...
            (SurfaceRole::ErrorContainer, "ErrorContainer"),
            (SurfaceRole::Container, "Container"),
            (SurfaceRole::ContainerRaised, "ContainerRaised"),
            (SurfaceRole::ContainerSunken, "ContainerSunken"),
