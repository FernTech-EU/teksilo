//! Trait + types + registry for FernUI's widget previewer
//! infrastructure.
//!
...
//! sibling [`fern-preview-ui`](../fern_preview_ui/index.html) crate;
//! per-application binaries (`fern-widgets-previewer`, etc.) link the
...
#[doc(hidden)]
pub mod __widget {
    pub use fern_core::widget::Widget;
}

#[doc(hidden)]
pub mod __widget_id {
    pub use fern_core::widget_id::WidgetId;
}
