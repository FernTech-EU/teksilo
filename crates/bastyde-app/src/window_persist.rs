...
//!    is clamped down. See
//!    [`PerWindowState::sanitize`](bastyde_settings::PerWindowState::sanitize).
...
use bastyde_core::{Signal, WindowConfig, WindowState};
use bastyde_settings::{PerWindowState, WindowStateService};
...
fn observe<T: Clone + 'static>(
    signal: &Signal<T>,
    service: WindowStateService,
    placement: Signal<bastyde_core::WindowPlacement>,
    size: Signal<(u32, u32)>,
