...
pub struct LayoutContext<'a> {
    ...
    pub text_backend: Option<&'a std::rc::Rc<std::cell::RefCell<dyn teksilo_canvas::TextBackend>>>,
...
impl<'a> LayoutContext<'a> {
    ...
    pub fn widget_bounds(&self, id: WidgetId) -> Option<teksilo_canvas::Rect> {
        let arena = self.arena?;
    ...
    pub fn child_alignment(&self, child_id: WidgetId) -> Option<teksilo_tokens::Alignment> {
        let arena = self.arena?;
