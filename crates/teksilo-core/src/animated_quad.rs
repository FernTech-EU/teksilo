...
impl AnimatedQuadHandle {
    ...
    /// [`teksilo_canvas::Canvas::draw_animated_quad`] at paint time.
...
/// (see `anim_procedural.wgsl` / `anim_sprite.wgsl` in `teksilo-render`).
#[derive(Debug, Clone)]
pub enum AnimatedQuadKind {
    ...
    /// [`teksilo_widgets::ProgressBar::indeterminate`](https://docs.rs/teksilo-widgets/latest/teksilo_widgets/struct.ProgressBar.html).
    IndeterminateSweep {
        period: Duration,
    ...
    /// Matches [`teksilo_widgets::Spinner`](https://docs.rs/teksilo-widgets/latest/teksilo_widgets/struct.Spinner.html).
    SpinnerArc {
