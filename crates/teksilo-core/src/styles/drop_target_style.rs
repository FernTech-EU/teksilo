...
//! rebuild.
//!
//! [`DropZone`]: ../../teksilo_widgets/drop_zone
...
/// One of the five drop regions a [`DropTarget`](../../teksilo_widgets/drop_target)
...
/// Which [`DropRegion`]s a [`DropTarget`](../../teksilo_widgets/drop_target)
...
/// Tier-3 style protocol for [`DropTarget`](../../teksilo_widgets/drop_target).
