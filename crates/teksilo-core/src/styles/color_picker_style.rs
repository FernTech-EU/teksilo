...
//! gradient), `HueStrip`, `AlphaStrip` (widget-internal `pub(crate)`
//! types) and `ColorSwatch` — paint the colour space itself; replacing
//! them is a fork-worthy change, not a theming one.
//!
