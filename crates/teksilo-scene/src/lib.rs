...
//!
//! See [`docs/teksilo-scene.md`](https://github.com/ferntech-eu/teksilo/blob/main/docs/teksilo-scene.md)
//! for the user-facing reference and
//! [`docs/teksilo-scene-a11y.md`](https://github.com/ferntech-eu/teksilo/blob/main/docs/teksilo-scene-a11y.md)
...
// `teksilo_scene::Foo` (never `teksilo_scene::flags::Foo` etc). Narrowing
