...
impl PlatformWindow {
    ...
    pub async fn new_with_a11y(
        ...
        let a11y_adapter = accesskit_winit::Adapter::with_direct_handlers(
            event_loop,
            &window,
            BastydeActivationHandler,
            BastydeActionHandler { tx: action_tx },
            BastydeDeactivationHandler,
        );
    ...
    /// Used by `bastyde_platform::create_title_bar_host` and other components
...
struct BastydeActivationHandler;

impl accesskit::ActivationHandler for BastydeActivationHandler {
...
struct BastydeActionHandler {
    tx: mpsc::Sender<ActionRequest>,
}

impl accesskit::ActionHandler for BastydeActionHandler {
...
struct BastydeDeactivationHandler;

impl accesskit::DeactivationHandler for BastydeDeactivationHandler {
