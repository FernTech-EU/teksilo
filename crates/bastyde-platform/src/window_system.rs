...
//!   exactly; any divergence means Bastyde and winit
...
/// honouring it here would make Bastyde disagree with the backend that actually
...
/// [`ParentHandle`](bastyde_core::raw_handle::ParentHandle)) in hand should
...
mod tests {
    ...
    // tests are the tripwire — Bastyde predicting a different backend than
    ...
    /// session makes winit create a genuine X11 client. Bastyde must follow,
