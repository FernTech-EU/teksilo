...
pub trait SceneItem: std::fmt::Debug + 'static {
    ...
    fn thumbnail_color(&self) -> bastyde_tokens::Color {
        bastyde_tokens::Color::new(0.6, 0.6, 0.6, 1.0)
    }
    ...
    /// [`RenderFrame`](bastyde_canvas::RenderFrame) and replay it on
    ...
    /// appropriate [`BindingLevel`](bastyde_core::binding::BindingLevel).
