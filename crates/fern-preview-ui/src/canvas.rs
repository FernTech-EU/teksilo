...
impl PreviewCanvas {
    ...
    fn build_inner_widget(
        &self,
        registry: &fern_core::binding::BindingRegistry,
        self_id: fern_core::widget_id::WidgetId,
    ) -> Box<dyn Widget> {
        ...
        knobs.bind_all(self_id, registry, fern_core::binding::BindingLevel::Rebuild);
...
impl PreviewCanvas {
    ...
    fn build_footer(&self, ctx: &mut BuildContext) -> impl Widget + 'static {
        ...
        let _ = ctx;
        fern_widgets::primitives::Padding::symmetric(4.0, 12.0).child(
            HStack::new()
                .spacing(12.0)
                .child(label_widget)
                .child(Spacer::new())
