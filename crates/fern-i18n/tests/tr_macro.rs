...
//! `fern-i18n-macros`. Validates end-to-end behavior: compile-time key
//! checking against `fern-i18n/locales/en-US.ftl`, runtime resolution
...
fn multiple_args_are_all_bound() {
    ...
    // validation reads fern-i18n/locales/en-US.ftl, not this runtime
