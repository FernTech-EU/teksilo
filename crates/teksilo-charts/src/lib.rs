...
//! `teksilo-charts` — BarChart, LineChart, and PieChart for Teksilo.
//!
//! All three render via the existing [`teksilo_canvas`] Path / fill_rect /
...
//!
//! Series data lives in a [`teksilo_data::ChartModel`] — the reactive,
