...
use teksilo_tokens::{TextRole, TextStyle};
...
impl ReferenceLine {
    ...
    pub fn bare(value: f32) -> Self {
        Self::new(value, teksilo_i18n::lit!(String::new()))
    }
    ...
    pub(crate) fn resolved_color(&self, theme: &Theme, enabled: bool) -> teksilo_tokens::Color {
        match &self.color {
...
mod tests {
    ...
    fn the_default_line_is_a_thin_secondary_dash() {
        let l = ReferenceLine::new(1.0, teksilo_i18n::lit!("m"));
    ...
    fn a_line_can_be_recoloured_widened_and_made_solid() {
        let l = ReferenceLine::new(1.0, teksilo_i18n::lit!("m"))
            .color(teksilo_tokens::TextRole::Primary)
            .width(2.0)
            .solid();
