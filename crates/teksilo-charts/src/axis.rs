...
/// ## The transform
///
/// [`Canvas::translate`](teksilo_canvas::Canvas::translate) and
/// [`rotate`](teksilo_canvas::Canvas::rotate) **post-multiply**: they compose in output
...
///
/// [`Canvas::apply_transform`](teksilo_canvas::Canvas::apply_transform) is the
...
/// `teksilo-scene`'s rotated text item does it.
...
pub fn tilted_label_transform(angle: f32, center_x: f32, top: f32) -> teksilo_canvas::Transform2D {
