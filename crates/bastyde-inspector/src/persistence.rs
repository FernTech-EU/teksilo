...
//! Inspector state persistence via `bastyde_settings::SettingsStore`.
//!
...
//! changes).
//!
//! Keys live under the framework-reserved `__bastyde_inspector.*`
...
const KEY_PANEL_HEIGHT: &str = "__bastyde_inspector.panel_height";
