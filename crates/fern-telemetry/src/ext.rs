...
//!
//! Same convention as
//! [`fern_settings::SettingsExt`](fern_settings::SettingsExt). Apps
//! `use fern_telemetry::TelemetryExt;` to reach `ctx.consent()`,
