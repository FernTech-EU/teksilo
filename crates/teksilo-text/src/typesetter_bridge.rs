...
pub struct TypesetterBridge {
    ...
    /// `RenderFrame`. teksilo-app consumes the atlas through
...
impl TypesetterBridge {
    ...
    /// Convert a teksilo-tokens TextStyle to a text-typeset TextFormat.
    ...
    ///
    /// Rich-text widgets (`teksilo_text::RichTextEngine` driving the
