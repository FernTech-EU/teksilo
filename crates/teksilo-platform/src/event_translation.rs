...
use teksilo_core::event::{Key, Modifiers, PointerButton, ScrollDelta, WidgetEvent};
...
pub fn translate_mouse_wheel(
    ...
    // Teksilo's ScrollDelta uses positive y = increase scroll offset (content moves up).
...
// into Teksilo GestureEvents, which can be dispatched as WidgetEvent::Gesture.
