...
impl ColorTokens {
    pub fn light_default() -> Self {
        Self {
            ...
            on_surface_secondary: Color::from_hex("#757575"),
            ...
            focus_ring: Color::from_rgba(0.08, 0.40, 0.75, 0.5),
