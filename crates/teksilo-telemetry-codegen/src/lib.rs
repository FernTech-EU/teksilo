...
//! `teksilo-telemetry-codegen` — compile-time codegen for Teksilo telemetry.
//!
...
//!   `teksilo_telemetry::Event` and hands it to the reporter.
//!
//! # Usage
//!
//! ```rust,ignore
...
//! | `i64`         | `i64`                           | `I64`                       |
//! | `bool`        | `bool`                          | `Bool`                      |
//! | `f64_bucket`  | `teksilo_telemetry::F64Bucket`     | `F64Bucket`                 |
