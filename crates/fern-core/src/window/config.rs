...
impl WindowConfig {
    ...
    ///
    /// Defaults: title `"FernUI"`, size `800x600`,
    ...
    pub fn modal_to(mut self, parent: FernWindowId) -> Self {
    ...
    pub fn modal_parent(&self) -> Option<FernWindowId> {
