...
use bastyde_core::telemetry::OwnedEvent;
...
impl EventQueue for PersistentEventQueue {
    fn push(&self, event: OwnedEvent) {
        ...
        if let Err(e) = (|| -> Result<(), PersistentQueueError> {
            ...
            // signal if they care.
            eprintln!("bastyde-telemetry: persistent queue push failed: {e}");
        }
    }
    ...
    fn drain_batch(&self, n: usize) -> Vec<OwnedEvent> {
        ...
        match (|| -> Result<Vec<OwnedEvent>, PersistentQueueError> {
                    ...
                    match serde_json::from_slice::<PersistedRecord>(bytes) {
                        ...
                        Err(_) => taken.push((
                            ...
                            OwnedEvent {
                                ...
                                category: bastyde_core::telemetry::EventCategory::Custom,
            ...
            Ok(events) => events,
            Err(e) => {
                eprintln!("bastyde-telemetry: persistent queue drain failed: {e}");
                Vec::new()
            }
        }
    }
    ...
    fn discard_all(&self) {
        ...
        if let Err(e) = (|| -> Result<(), PersistentQueueError> {
            ...
            eprintln!("bastyde-telemetry: persistent queue discard failed: {e}");
        }
    }
