...
/// Translate a winit mouse button to a fern-core PointerButton.
...
/// Translate winit keyboard modifiers to fern-core Modifiers.
...
/// Translate a winit logical key to a fern-core Key.
...
// into FernUI GestureEvents, which can be dispatched as WidgetEvent::Gesture.

/// Translate a winit PinchGesture into a FernUI gesture event.
