//! GUI for Bastyde's widget previewer.
//!
//! This crate is a *library*. Per-application binaries
//! (`bastyde-widgets-previewer`, `<app>-previewer`) call
//! [`run_previewer`] from their `main`, linking against this crate
//! plus `bastyde-preview` plus their own widget set with the `preview`
...
use bastyde_app::{BastydeAppBuilder, ThemeMode};
use bastyde_core::WindowConfig;
