...
//!
//! Bastyde's six `TextStyle` slots are mapped onto the M3 type scale. The
//! font *family* is left as Bastyde's bundled Inter (text) / JetBrains
...
use bastyde_tokens::{FontWeight, TypographyTokens};
