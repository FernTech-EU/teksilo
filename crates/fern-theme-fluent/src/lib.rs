//! Fluent (Windows 11) theme preset for FernUI.
//!
//! **Stub.** The constructors return a `fern_core::Theme` shaped from
...
//!
//! ```ignore
//! use fern_theme_fluent as fluent;
//!
//! FernAppBuilder::new()
//!     .theme(fluent::light())
...
use fern_core::styles::{Theme, ThemeAppearance};
