...
//!    [`crates/fern-widgets/locales/en-US.ftl`](../../../locales/en-US.ftl)
...
//!    [`ConsentScope`](fern_telemetry::ConsentScope) field, intersected
...
fn build_inspect_accordion(telemetry: &OpenedTelemetry, n: usize) -> Accordion {
    ...
    use fern_telemetry::{EventQueue, OwnedPropValue};
