...
//! existing `fern_data::SelectionModel` keyed by visible row index.
//!
...
///
/// Mirrors `fern_data::SelectionModel`'s API surface (signal-backed,
...
impl CellSelectionModel {
    ...
    /// callers in row mode should use `fern_data::SelectionModel`.
