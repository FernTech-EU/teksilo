...
use fern_core::styles::{SegmentedControlStyleConfig, SharedSegmentedControlStyle};
...
impl SegmentedControl {
    ...
    pub fn style(mut self, style: impl fern_core::styles::SegmentedControlStyle) -> Self {
