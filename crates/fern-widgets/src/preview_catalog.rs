//! `WidgetCatalog` impls for `fern-widgets`.
//!
...
register_widget_catalog_at!("crates/fern-widgets/src/button.rs", Button);
...
register_widget_catalog_at!("crates/fern-widgets/src/radio_button.rs", RadioButton);
...
register_widget_catalog_at!("crates/fern-widgets/src/slider.rs", Slider);
...
register_widget_catalog_at!("crates/fern-widgets/src/progress_bar.rs", ProgressBar);
...
register_widget_catalog_at!("crates/fern-widgets/src/combo_box.rs", ComboBox<String>);
...
register_widget_catalog_at!(
    "crates/fern-widgets/src/primitives/divider.rs",
...
register_widget_catalog_at!("crates/fern-widgets/src/card.rs", Card);
...
register_widget_catalog_at!("crates/fern-widgets/src/panel.rs", Panel);
...
register_widget_catalog_at!("crates/fern-widgets/src/group_box.rs", GroupBox);
...
impl WidgetCatalog for GroupHeader {
    ...
    fn build(_variant: &str, knobs: &KnobValues) -> Box<dyn Widget> {
        Box::new(GroupHeader::new(fern_i18n::LocalizedString::literal(
...
impl WidgetCatalog for Snackbar {
    ...
    fn build(_variant: &str, knobs: &KnobValues) -> Box<dyn Widget> {
        ...
        Box::new(
            Snackbar::new(fern_i18n::LocalizedString::literal(trigger_label))
                .content(popup_content),
        )
    }
}
register_widget_catalog_at!("crates/fern-widgets/src/snackbar.rs", Snackbar);
...
register_widget_catalog_at!("crates/fern-widgets/src/breadcrumb.rs", Breadcrumb);
...
register_widget_catalog_at!("crates/fern-widgets/src/toolbar.rs", Toolbar);
...
register_widget_catalog_at!("crates/fern-widgets/src/status_bar.rs", StatusBar);
...
register_widget_catalog_at!("crates/fern-widgets/src/radio_group.rs", RadioGroup);
...
register_widget_catalog_at!("crates/fern-widgets/src/split_button.rs", SplitButton);
...
register_widget_catalog_at!("crates/fern-widgets/src/list_view.rs", ListView<String>);
...
impl WidgetCatalog for TreeView<String> {
    ...
    fn variants() -> Vec<PreviewVariant> {
        fn build_default() -> Box<dyn Widget> {
            ...
            model.insert_child(crates_node, 0, "fern-core".to_string());
            model.insert_child(crates_node, 1, "fern-widgets".to_string());
            model.insert_child(crates_node, 2, "fern-render".to_string());
...
register_widget_catalog_at!("crates/fern-widgets/src/menu_list.rs", MenuList);
...
register_widget_catalog_at!("crates/fern-widgets/src/scroll_area.rs", ScrollArea);
...
register_widget_catalog_at!("crates/fern-widgets/src/split_view.rs", SplitView);
...
register_widget_catalog_at!("crates/fern-widgets/src/tab_widget.rs", TabWidget);
...
register_widget_catalog_at!("crates/fern-widgets/src/tool_box.rs", ToolBox);
