...
//! installed via `FernAppBuilder.install_toast(opts)` from the `fern-ui`
...
//! [`OverlayPlacement::ViewportCorner`](fern_core::overlay::OverlayPlacement)
//! variant.
//!
//! ```ignore
//! ctx.show_toast(
...
pub use fern_core::styles::{ToastPriority, ToastStyleConfig};
...
pub use fern_core::styles::BannerSeverity as ToastSeverity;
...
impl ToastAction {
    ...
    pub fn new_literal(
        ...
        Self::new(fern_i18n::LocalizedString::literal(label), on_invoke)
    }
...
pub struct Toast {
    ...
    pub(crate) style_override: Option<fern_core::styles::SharedToastStyle>,
}
...
impl Toast {
    fn build_with_severity(
        ...
        title: impl Into<fern_i18n::LocalizedString>,
    ) -> Self {
    ...
    pub fn loading(title: impl Into<fern_i18n::LocalizedString>) -> Self {
        Self::build_with_severity(ToastSeverity::Info, title)
            .persistent()
    ...
    pub fn loading_literal(title: impl Into<String>) -> Self {
        Self::loading(fern_i18n::LocalizedString::literal(title))
    }

    // ----- Body content -----

    /// Optional secondary line below the title.
    pub fn body(mut self, text: impl Into<fern_i18n::LocalizedString>) -> Self {
        let ls: fern_i18n::LocalizedString = text.into();
    ...
    pub fn body_literal(self, text: impl Into<String>) -> Self {
        self.body(fern_i18n::LocalizedString::literal(text))
    }
    ...
    pub fn announcement_literal(self, text: impl Into<String>) -> Self {
        self.announcement(fern_i18n::LocalizedString::literal(text))
    }
    ...
    pub fn style(mut self, style: impl fern_core::styles::ToastStyle) -> Self {
...
mod tests {
    ...
    ) -> fern_core::accessibility::AccessNodeBuilder {
    ...
    fn surface_live_for(
        severity: ToastSeverity,
        priority: ToastPriority,
    ) -> fern_core::accesskit::Live {
        let mut node = surface_node(severity, priority);
        node.inner_mut()
            .live()
            .unwrap_or(fern_core::accesskit::Live::Off)
    }
    ...
    ) -> (fern_core::widget_tree::WidgetTree, ToastRegistry) {
    ...
    fn host_renders_a_toast_surface_for_each_live_entry() {
        ...
        assert!(
            tree.find_by_role(fern_core::accesskit::Role::Status)
                .is_some(),
    ...
    fn builder_chain_typechecks() {
        let _t = Toast::warning(fern_i18n::LocalizedString::literal("Heads up"))
            .body_literal("Something happened")
            .action(ToastAction::new_literal("Open", |_| {}))
            .primary_action(fern_i18n::LocalizedString::literal("Fix"), |_| {})
