...
fn picker_click_populates_chain_with_button_ancestor() {
    ...
    tree.pointer_down_button(center, teksilo_core::event::PointerButton::Primary);
    ...
    tree.pointer_up_button(center, teksilo_core::event::PointerButton::Primary);
    tree.layout(SizeProposal::exact(400.0, 300.0));
...
fn tab_content_fills_panel_width() {
    ...
    fn deepest_full_height_descendant(
        ...
        id: WidgetId,
        depth: u32,
    ) -> (WidgetId, teksilo_canvas::Rect, u32) {
    ...
    fn deepest_tall(
        ...
        id: WidgetId,
        depth: u32,
    ) -> Option<(WidgetId, teksilo_canvas::Rect, u32)> {
...
fn overflow_stripes_collected_for_overflowing_user_root() {
    ...
    use teksilo_widgets::primitives::{FixedSize, HStack};
