...
//! Inspector state persistence via `teksilo_settings::SettingsStore`.
//!
...
//! changes).
//!
//! Keys live under the framework-reserved `__teksilo_inspector.*`
...
const KEY_OPEN: &str = "__teksilo_inspector.open";
const KEY_OVERFLOW: &str = "__teksilo_inspector.overflow_overlay";
const KEY_BOUNDS_MODE: &str = "__teksilo_inspector.bounds_mode";
const KEY_OVERLAY_OPACITY: &str = "__teksilo_inspector.overlay_opacity";
const KEY_ACTIVE_TAB: &str = "__teksilo_inspector.active_tab";
const KEY_PANEL_HEIGHT: &str = "__teksilo_inspector.panel_height";
