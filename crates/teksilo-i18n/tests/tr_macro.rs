...
//! `teksilo-i18n-macros`. Validates end-to-end behavior: compile-time key
//! checking against `teksilo-i18n/locales/en-US.ftl`, runtime resolution
...
use teksilo_i18n::{I18nConfig, I18nManager, LanguageIdentifier, LocalizedString, tr};
...
fn multiple_args_are_all_bound() {
    ...
    // validation reads teksilo-i18n/locales/en-US.ftl, not this runtime
