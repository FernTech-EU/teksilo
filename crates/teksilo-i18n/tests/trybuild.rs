...
//! at a single shared fixture via the `TEKSILO_I18N_SOURCE_PATH`
//! environment variable (an override supported by
//! [`teksilo_i18n_macros::tr`] since Phase C). Setting the env var here
...
fn ui() {
    ...
    unsafe {
        std::env::set_var("TEKSILO_I18N_SOURCE_PATH", fixture);
    }
