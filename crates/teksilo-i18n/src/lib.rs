...
//! Internationalization runtime for Teksilo.
//!
...
//! `teksilo-i18n-macros` crate (Phase C) and are re-exported here as part of
//! `teksilo-i18n`'s public surface.
...
/// module: `TeksiloAppBuilder` calls `install` / `clear`, `LocalizedString`
...
pub use format::{
    CalendarSystem, DateFields, DateStyle, NumberFormatter, NumberStyle, NumberSymbols,
    TeksiloDateTime, TeksiloDateTimeFormatter, TimeStyle, delocalize_number,
};
...
pub use teksilo_i18n_macros::{tr, tr_signal, tr_signal_widget, tr_widget};
...
///
/// ```ignore
/// use teksilo_i18n::{compile_in_locales, I18nConfig};
///
