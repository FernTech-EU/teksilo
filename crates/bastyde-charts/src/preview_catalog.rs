...
//! `WidgetCatalog` impls for `bastyde-charts`.
//!
...
//! `bastyde-widgets/src/preview_catalog.rs`.
//!
...
use bastyde_data::{ChartDatum, ChartModel, ChartSeries};
use bastyde_preview::{
...
register_widget_catalog_at!("crates/bastyde-charts/src/bar_chart.rs", BarChart<String>);
...
register_widget_catalog_at!("crates/bastyde-charts/src/line_chart.rs", LineChart<String>);
...
register_widget_catalog_at!("crates/bastyde-charts/src/pie_chart.rs", PieChart<String>);
