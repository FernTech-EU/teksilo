...
//! same [`bastyde_data::ChartModel`] and palette.
//!
...
use bastyde_data::{ChartModel, SeriesId};
...
impl<T: Clone + 'static> ChartLegend<T> {
    fn item_widths(
        &self,
        backend: Option<&std::rc::Rc<std::cell::RefCell<dyn bastyde_canvas::TextBackend>>>,
