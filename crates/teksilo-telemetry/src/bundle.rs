...
//! `TeksiloAppBuilder` integration.
//!
//! Mirrors [`teksilo_settings::SettingsBundle`] / `OpenedSettings`:
...
use teksilo_core::telemetry::UsageReporter;
use teksilo_settings::{AppPaths, SettingsFileError, SettingsStore};
...
/// `TeksiloAppBuilder::install_telemetry`.
#[derive(Clone)]
...
impl OpenedTelemetry {
    ...
    pub fn discard_pending(&self) -> Result<(), teksilo_core::telemetry::TelemetryError> {
