...
impl EventQueue for PersistentEventQueue {
    fn push(&self, event: OwnedEvent) {
        ...
        if let Err(e) = (|| -> Result<(), PersistentQueueError> {
            ...
            // signal if they care.
            eprintln!("teksilo-telemetry: persistent queue push failed: {e}");
        }
    }
    ...
    fn drain_batch(&self, n: usize) -> Vec<OwnedEvent> {
        ...
        match (|| -> Result<Vec<OwnedEvent>, PersistentQueueError> {
                    ...
                    match serde_json::from_slice::<PersistedRecord>(bytes) {
                        ...
                        Err(_) => taken.push((
                            ...
                            OwnedEvent {
                                ...
                                category: teksilo_core::telemetry::EventCategory::Custom,
            ...
            Ok(events) => events,
            Err(e) => {
                eprintln!("teksilo-telemetry: persistent queue drain failed: {e}");
                Vec::new()
            }
        }
    }
    ...
    fn discard_all(&self) {
        ...
        if let Err(e) = (|| -> Result<(), PersistentQueueError> {
            ...
            eprintln!("teksilo-telemetry: persistent queue discard failed: {e}");
        }
    }
