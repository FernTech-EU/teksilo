...
//! sits *on top of* the wgpu surface. What Bastyde owns is the **overlay
...
/// here (not in `bastyde-webview`) so the core style trait and the default
...
/// Tier-3 style protocol for [`WebView`](../../bastyde_webview/struct.WebView.html).
