...
//! Tier-3 style protocol for `BarChart` / `LineChart` / `PieChart` (bastyde-charts).
...
//! the shipped default, lives in bastyde-charts itself (NOT bastyde-widgets), because
//! bastyde-charts does not depend on bastyde-widgets. bastyde-core only holds the trait
