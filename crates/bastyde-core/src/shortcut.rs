...
impl fmt::Display for KeyStroke {
    ...
    // use `bastyde_widgets::keystroke_format::format_keystroke()` instead,
    // which handles platform-specific symbols (⌘ on macOS) and locale-
    // aware modifier names ("Strg" in German) via bastyde-i18n.
...
/// locale changes through a `Signal<String>` without bastyde-core
/// depending on bastyde-i18n. Apps convert their `LocalizedString`
